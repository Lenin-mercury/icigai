              ...
              return (
                ...
                >
                  ...
                  <form onSubmit={onCreate}>
                    ...
                    <button onClick={() => setPubToggle(false)}>cancel</button>
                  </form>{
                    (column.name === 'Public'
                      && <button  onClick={() => setPubToggle(!pubtoggle)}>Add To Public</button>)
                    || (column.name === 'Private' && <button  onClick={() => setPubToggle(!pubtoggle)}>Add To Private</button>)
                  }
                  <div style={{ margin: 8 }}>
